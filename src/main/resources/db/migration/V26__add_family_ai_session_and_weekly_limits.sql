...
ALTER TABLE special_premium_grants ADD COLUMN ai_session_started_at TIMESTAMP WITH TIME ZONE;
...
ALTER TABLE special_premium_grants ADD COLUMN ai_weekly_started_at TIMESTAMP WITH TIME ZONE;
